...
class TFIDFFeatureExtractor:
    ...
    def fit(self, texts: pd.Series, labels: pd.Series) -> "TFIDFFeatureExtractor":
        ...
        logger.info(
            f"Parameters: max_features={self.max_features}, "
    ...
    def transform(
        self, texts: pd.Series, labels: pd.Series = None
...
def create_features(
    ...
    X_val, y_val = extractor.transform(val_df["text_processed"], val_df["label_binary"])

    logger.info("Transforming test data...")
    X_test, y_test = extractor.transform(
        test_df["text_processed"], test_df["label_binary"]
    )
